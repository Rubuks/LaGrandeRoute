...
//  'quest') est ajoutée par socle23.js.
...
const OBJETS={
  ...
  foudre:{img:'v_vigor',n:'w.item.foudre.name',em:"⚗️",cls:"loup",p:65,tox:25,d:'w.item.foudre.desc',use(){C.hst.foudre=3;log(t('w.itemlog.foudre.drink'));}},
  ...
  samum:{img:'v_bomb',n:'w.item.samum.name',em:"💨",cls:"loup",p:60,tox:10,sfx:"crit",d:'w.item.samum.desc',use(){const e=curFoe();if(!e)return;e.st.etourdi=1;if(e.vole){e.chute+=2;log(t('w.itemlog.samum.fly'));}else log(t('w.itemlog.samum.ground'));}},
  ...
  poudre:{img:'v_vigor',n:'w.item.poudre.name',em:"💠",cls:"sorciere",p:65,tox:15,d:'w.item.poudre.desc',use(){C.hst.foudre=3;log(t('w.itemlog.poudre.drink'));}},
  ...
  elan:{img:'v_vigor',n:'w.item.elan.name',em:"🍃",cls:"eclaireuse",p:60,tox:15,d:'w.item.elan.desc',use(){C.hst.foudre=3;log(t('w.itemlog.elan.drink'));}}
};
